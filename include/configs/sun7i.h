...
#define CONFIG_SYS_PROMPT		"unibs#"
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"loadinitrd=ext4load nand 2:0 $initrdaddr /boot${initrd}\0" \ 
	"setmachid=setenv machid 10bb\0" \
	"setargs_nand=run loadbootenv loadscriptbin loadkernel loadinitrd setmachid\0" \
    	"boot_normal=bootm 48000000 50000000\0" \
